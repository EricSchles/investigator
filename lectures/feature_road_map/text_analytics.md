There are various analyses that would be interesting to track from text in sex ads this listing shows a set of metrics that would be interesting to track:
